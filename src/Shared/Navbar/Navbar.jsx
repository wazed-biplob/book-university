    ...
    <>
      <div>
        <header className="p-4 bg-gray-800 text-gray-100">
          <div className="container relative flex justify-around items-center h-16 mx-auto">
            {show ? (
              <>
                <div className="absolute right-0 top-20 bg-slate-500 lg:hidden">
                  {navLinks}
                </div>
              </>
            ) : (
            ...
            <Link to="/" className="flex items-center p-2">
              ...
              <span style={{ fontSize: "22px" }} className="font-extrabold">
                ollegeBooker
              </span>
            </Link>
              ...
              <div className="max-w-lg p-4 shadow-md bg-gray-900 text-gray-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="leadi text-gray-400">{s.admissionProcess}</p>
                  </div>
                </div>
              </div>
            </div>
