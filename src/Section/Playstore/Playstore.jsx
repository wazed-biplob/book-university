...
const Playstore = () => {
  return (
    <div>
      <section className="py-6 my-4 bg-gray-800 text-gray-50">
        <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium tracki uppercase text-violet-400">
              Book College with our recently launched App
            </p>
            <h1 className="py-2 text-3xl font-medium leadi title-font">
              It's easier and smoother more than ever
            </h1>
          </div>
